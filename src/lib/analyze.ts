// Dummy analysis module. Replace `getDemoAnalysis` with a POST /analyze
// call later. Keep the return shape identical so UI stays untouched.
//
// Example future implementation:
//   const API_URL = import.meta.env.VITE_ANALYZE_API_URL;
//   export async function getDemoAnalysis(text, visibility) {
